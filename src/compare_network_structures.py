...
if __name__ == "__main__":
        ...
        fileName = "results/network_strucutre_variation_%s_%s_%s" % (str(params["N"]),str(params["time_steps_max"]),str(params["K"]))
        data = []
        
        network_structures_list = ["small world", "scale free" ,]
        ...
        for i in network_structures_list:
            #print(i)
