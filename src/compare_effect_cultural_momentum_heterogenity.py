...
if heterogenous_cultural_momentum:
    quick_changers_prop = 0.3
    alpha_quick_changers_cultural_momentum = 2#2  ##inital distribution parameters - doing the inverse inverts it!
    beta_quick_changers_cultural_momentum = 3#2  ##inital distribution parameters - doing the inverse inverts it!
    alpha_lagards_cultural_momentum = 3#3
    beta_lagards_cultural_momentum = 2#3
